  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        <h2 className="font-regitha fl-text-3xl/4xl">Two Rivals Sharpening Each Other</h2>
        ...
        <p className="fl-text-lg/2xl font-beezle text-center">
          By the 200th epoch, the generator has learned some more patterns and the flowers start to take shape. However, there are still some repeating artifacts in the images.
        </p>
        <p className="fl-text-lg/2xl font-beezle text-center">
          By the 3000th epoch, the generator is able to create realistic flowers. It starts to understand leaves in the background and even certain lighting effects.
        </p>
        <p className="fl-text-lg/2xl font-beezle text-center">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        <Frame>
          ...
          <img src={samples} alt="Samples" className="border border-slate-500 rounded-xl h-[75vh]" />
        </Frame>
      </div>
    </section>
  )
